...
Overlays that include **ServiceMonitor** (`deploy/components/prometheus-servicemonitors/`) scrape `product-catalog:8080/metrics` via Prometheus Operator. After apply, wait ~30s then in Grafana Explore:
